...
//        work.close();    
    ...
    /** 
         ...
         */  
    public static XSSFWorkbook createExcelFile(Class clazz, List objs,String sheetName) throws IllegalArgumentException,IllegalAccessException,  
    InvocationTargetException, ClassNotFoundException, IntrospectionException, ParseException, NoSuchMethodException, SecurityException{  
            ...
            Method getExcelBeanList = clazz.getDeclaredMethod("getExcelBeanList");
            map.put(0, (List<ExcelBean>) getExcelBeanList.invoke(null));
